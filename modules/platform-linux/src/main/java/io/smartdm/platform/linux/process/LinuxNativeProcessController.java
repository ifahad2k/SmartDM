...
public class LinuxNativeProcessController implements NativeProcessController, AutoCloseable {

    private final ExecutorService ioExecutor;
    private final ScheduledExecutorService scheduler;
    private final boolean ownsExecutors;

    public LinuxNativeProcessController(ExecutorService ioExecutor, ScheduledExecutorService scheduler) {
        this.ioExecutor = Objects.requireNonNull(ioExecutor);
        this.scheduler = Objects.requireNonNull(scheduler);
        this.ownsExecutors = false;
    }

    public LinuxNativeProcessController() {
