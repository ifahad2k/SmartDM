...
class WindowsNativeProcessControllerTest {

    private ExecutorService ioExecutor;
    private ScheduledExecutorService scheduler;
    private WindowsNativeProcessController controller;
    ...
    void setUp() {
        ...
        controller = new WindowsNativeProcessController(ioExecutor, scheduler);
    ...
    void testStdoutLimit() throws Exception {
        // Output 1000 lines of 100 chars
        OutputLimits limits = new OutputLimits(1000, 1000, 1000); // 1000 bytes limit
